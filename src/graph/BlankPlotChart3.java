...
public class BlankPlotChart3 extends JComponent {

    public BlankPlotChatRender3 getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(BlankPlotChatRender3 blankPlotChatRender) {
    ...
    private BlankPlotChatRender3 blankPlotChatRender;

    public BlankPlotChart3() {
    ...
    private void createLabelText(Graphics2D g2) {
        if (labelCount > 0) {
            ...
            double locationX = insets.left + -33 + 0;
    ...
    private void renderSeries(Graphics2D g2) {
        if (blankPlotChatRender != null) {
            ...
            double height = getHeight() - insets.top - insets.bottom - textHeight;
            double space = width / labelCount;
            double locationX = insets.left + -33 + spaceText;
            for (int i = 0; i < labelCount; i++) {
